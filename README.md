...
### 💧 Watermarking
To support provenance and responsible AI deployment, the generator module employs watermarking functionality. Each generated text is embedded with a statistical or algorithmic watermark using adapted scripts from [`lm-watermarking`](https://github.com/jwkirchenbauer/lm-watermarking). This watermarking allows for subsequent identification and verification of text provenance, making it possible to establish attribution, monitor outputs in downstream systems, and prevent unauthorized reuse. Incorporating watermarking is critical in legal and compliance contexts, as it helps to reliably track which texts were generated by this pipeline.
